...
VL_ATTR_COLD void Vrvfpgasim_dpram64__S1000___ctor_var_reset(Vrvfpgasim_dpram64__S1000* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrvfpgasim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrvfpgasim_dpram64__S1000___ctor_var_reset\n"); );
    // Body
