...
VL_ATTR_COLD void Vrvfpgasim___024root___dump_triggers__stl(Vrvfpgasim___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.d_d)\n");
    }
    if ((4ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 2 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_wen or [hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_inv_reset_val)\n");
    }
    if ((8ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 3 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r)\n");
    }
    if ((0x10ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 4 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r or [hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x20ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 5 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x40ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 6 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.exu.i_mul.bfp_len)\n");
    }
    if ((0x80ULL & vlSelf->__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 7 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.lsu_lsc_ctl.lsu_error_pkt_m)\n");
    }
...
VL_ATTR_COLD void Vrvfpgasim___024root___dump_triggers__act(Vrvfpgasim___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.d_d)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_wen or [hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_inv_reset_val)\n");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r)\n");
    }
    if ((8ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r or [hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x10ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x20ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.exu.i_mul.bfp_len)\n");
    }
    if ((0x40ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.lsu_lsc_ctl.lsu_error_pkt_m)\n");
    }
...
VL_ATTR_COLD void Vrvfpgasim___024root___dump_triggers__nba(Vrvfpgasim___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.d_d)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_wen or [hybrid] rvfpgasim.veerwolf.rvtop.veer.dec.decode.cam_inv_reset_val)\n");
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r)\n");
    }
    if ((8ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_r or [hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x10ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.ldst_dual_m)\n");
    }
    if ((0x20ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.exu.i_mul.bfp_len)\n");
    }
    if ((0x40ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @([hybrid] rvfpgasim.veerwolf.rvtop.veer.lsu.lsu_lsc_ctl.lsu_error_pkt_m)\n");
    }
