...
class alignas(VL_CACHE_LINE_BYTES) Vrvfpgasim_axi_demux_id_counters__pi5 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrvfpgasim_axi_demux_id_counters__pi5(Vrvfpgasim__Syms* symsp, const char* v__name);
